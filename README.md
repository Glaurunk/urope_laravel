...
So I have started with a basic laravel 8 installation with a basic auth scuffolding
I then added Vue, because I was familiar with the workflow from other projects. Then because I wanted to try out some store management to see if it is any good for my web dev endeavors I added VueEx and works like a charm, though in the end it seems to me Vue&Vuex are just too much of a trouble. I wonder If I could get things done with vanilla Javascript and workaround the state problem with cookies or something.
